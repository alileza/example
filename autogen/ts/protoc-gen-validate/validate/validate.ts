...
export const Int64Rules = {
  ...
  fromJSON(object: any): Int64Rules {
    ...
    message.notIn = [];
    if (object.const !== undefined && object.const !== null) {
      message.const = Long.fromString(object.const);
    } else {
      message.const = Long.ZERO;
    }
    if (object.lt !== undefined && object.lt !== null) {
      message.lt = Long.fromString(object.lt);
    } else {
      message.lt = Long.ZERO;
    }
    if (object.lte !== undefined && object.lte !== null) {
      message.lte = Long.fromString(object.lte);
    } else {
      message.lte = Long.ZERO;
    }
    if (object.gt !== undefined && object.gt !== null) {
      message.gt = Long.fromString(object.gt);
    } else {
      message.gt = Long.ZERO;
    }
    if (object.gte !== undefined && object.gte !== null) {
      message.gte = Long.fromString(object.gte);
    } else {
      message.gte = Long.ZERO;
    }
    if (object.in !== undefined && object.in !== null) {
      for (const e of object.in) {
        message.in.push(Long.fromString(e));
      }
    }
    if (object.notIn !== undefined && object.notIn !== null) {
      for (const e of object.notIn) {
        message.notIn.push(Long.fromString(e));
      }
    }
    return message;
  },
  fromPartial(object: DeepPartial<Int64Rules>): Int64Rules {
    ...
    message.notIn = [];
    if (object.const !== undefined && object.const !== null) {
      message.const = object.const as Long;
    } else {
      message.const = Long.ZERO;
    }
    if (object.lt !== undefined && object.lt !== null) {
      message.lt = object.lt as Long;
    } else {
      message.lt = Long.ZERO;
    }
    if (object.lte !== undefined && object.lte !== null) {
      message.lte = object.lte as Long;
    } else {
      message.lte = Long.ZERO;
    }
    if (object.gt !== undefined && object.gt !== null) {
      message.gt = object.gt as Long;
    } else {
      message.gt = Long.ZERO;
    }
    if (object.gte !== undefined && object.gte !== null) {
      message.gte = object.gte as Long;
    } else {
      message.gte = Long.ZERO;
    }
    if (object.in !== undefined && object.in !== null) {
...
export const UInt64Rules = {
  ...
  fromJSON(object: any): UInt64Rules {
    ...
    if (object.const !== undefined && object.const !== null) {
      ...
      message.const = Long.UZERO;
    }
    if (object.lt !== undefined && object.lt !== null) {
      message.lt = Long.fromString(object.lt);
    } else {
      message.lt = Long.UZERO;
    }
    if (object.lte !== undefined && object.lte !== null) {
      message.lte = Long.fromString(object.lte);
    } else {
      message.lte = Long.UZERO;
    }
    if (object.gt !== undefined && object.gt !== null) {
      message.gt = Long.fromString(object.gt);
    } else {
      message.gt = Long.UZERO;
    }
    if (object.gte !== undefined && object.gte !== null) {
      message.gte = Long.fromString(object.gte);
    } else {
      message.gte = Long.UZERO;
    }
    if (object.in !== undefined && object.in !== null) {
      for (const e of object.in) {
        message.in.push(Long.fromString(e));
...
export const StringRules = {
  ...
  fromJSON(object: any): StringRules {
    ...
    if (object.len !== undefined && object.len !== null) {
      message.len = Long.fromString(object.len);
    } else {
      message.len = Long.UZERO;
    }
    if (object.minLen !== undefined && object.minLen !== null) {
      message.minLen = Long.fromString(object.minLen);
    } else {
      message.minLen = Long.UZERO;
    }
    if (object.maxLen !== undefined && object.maxLen !== null) {
      message.maxLen = Long.fromString(object.maxLen);
    } else {
      message.maxLen = Long.UZERO;
    }
    if (object.lenBytes !== undefined && object.lenBytes !== null) {
      message.lenBytes = Long.fromString(object.lenBytes);
    } else {
      message.lenBytes = Long.UZERO;
    }
    if (object.minBytes !== undefined && object.minBytes !== null) {
      message.minBytes = Long.fromString(object.minBytes);
    } else {
      message.minBytes = Long.UZERO;
    }
    if (object.maxBytes !== undefined && object.maxBytes !== null) {
      message.maxBytes = Long.fromString(object.maxBytes);
    } else {
      message.maxBytes = Long.UZERO;
    }
  ...
  fromPartial(object: DeepPartial<StringRules>): StringRules {
    ...
    if (object.len !== undefined && object.len !== null) {
      message.len = object.len as Long;
    } else {
      message.len = Long.UZERO;
    }
    if (object.minLen !== undefined && object.minLen !== null) {
      message.minLen = object.minLen as Long;
    } else {
      message.minLen = Long.UZERO;
    }
    if (object.maxLen !== undefined && object.maxLen !== null) {
      message.maxLen = object.maxLen as Long;
    } else {
      message.maxLen = Long.UZERO;
    }
    if (object.lenBytes !== undefined && object.lenBytes !== null) {
      message.lenBytes = object.lenBytes as Long;
    } else {
      message.lenBytes = Long.UZERO;
    }
    if (object.minBytes !== undefined && object.minBytes !== null) {
      message.minBytes = object.minBytes as Long;
    } else {
      message.minBytes = Long.UZERO;
    }
    if (object.maxBytes !== undefined && object.maxBytes !== null) {
  ...
  toJSON(message: StringRules): unknown {
    ...
    message.wellKnownRegex !== undefined && (obj.wellKnownRegex = message.wellKnownRegex !== undefined ? knownRegexToJSON(message.wellKnownRegex) : undefined);
...
export const MapRules = {
  ...
  fromJSON(object: any): MapRules {
    ...
    if (object.minPairs !== undefined && object.minPairs !== null) {
      message.minPairs = Long.fromString(object.minPairs);
    } else {
      message.minPairs = Long.UZERO;
    }
    if (object.maxPairs !== undefined && object.maxPairs !== null) {
      message.maxPairs = Long.fromString(object.maxPairs);
    } else {
      message.maxPairs = Long.UZERO;
    }
  ...
  fromPartial(object: DeepPartial<MapRules>): MapRules {
    const message = { ...baseMapRules } as MapRules;
    if (object.minPairs !== undefined && object.minPairs !== null) {
      message.minPairs = object.minPairs as Long;
    } else {
      message.minPairs = Long.UZERO;
    }
    if (object.maxPairs !== undefined && object.maxPairs !== null) {
      message.maxPairs = object.maxPairs as Long;
    } else {
      message.maxPairs = Long.UZERO;
    }
    if (object.noSparse !== undefined && object.noSparse !== null) {
